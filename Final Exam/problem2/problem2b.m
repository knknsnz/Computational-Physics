...
for i=2:(N-1)
  ham(i,i-1) = coeff;
  ham(i,i) = -2*coeff+u;  % add potential function to the Hamiltonian operator
  ham(i,i+1) = coeff;
end
% First and last rows for periodic boundary conditions
ham(1,N) = coeff;   ham(1,1) = -2*coeff+u; ham(1,2) = coeff;
